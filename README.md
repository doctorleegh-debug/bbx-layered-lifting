...
상단 문구 “하나의 깊이로 끝내지 않습니다. / 피부 속 여러 레이어를 입체적으로 리프팅합니다.”, 요청한 장비 9종 순서, 배경을 제거한 인물과 모바일 배치, 얼굴·목 9개 부위의 증상 요약 및 선택 안내, 파스텔 핑크 3D 픽토그램 4종, 부위명과 제목 텍스트 모션을 반영했습니다. 장비별 타겟층 표시는 추가하지 않았습니다.
