...
.pdv-tags li{margin:0;font-size:13.5px;font-weight:600;letter-spacing:-.3px;color:var(--h);opacity:.9}
...
@media (max-width:768px){
  ...
  .pdv-shot{aspect-ratio:4/3;padding:18px;border-radius:16px}
...
`,f=`<!-- ═══ 뷰티블라썸의원 · 퍼스널 레이어드 리프팅 — 시술 과정 4단계 ═══
     ...
     이미지 자리는 자리표시자로 두었다. 코덱스가 R2 에 올린 뒤 URL 만 갈아끼우면 된다.
...
.ppc-no{display:flex;align-items:center;gap:9px;margin:0 0 14px;
  font-size:12px;font-weight:800;letter-spacing:.18em;color:var(--c);font-variant-numeric:tabular-nums}
.ppc-no::after{content:'';flex:1;height:1px;background:linear-gradient(90deg,var(--c),transparent)}

/* 이미지 자리 — 실제 사진이 오면 <img> 로 교체 */
.ppc-figure{margin:0 0 16px;aspect-ratio:4/3;border-radius:14px;overflow:hidden;
  ...
  background:var(--paper);border:1.5px dashed #dfcfcd}
.ppc-figure img{width:100%;height:100%;object-fit:cover;border-radius:14px}
.ppc-ph{display:block;font-size:11.5px;line-height:1.65;color:var(--mute);letter-spacing:-.2px}
.ppc-ph b{display:block;margin:0 0 4px;font-size:12.5px;font-weight:700;color:var(--c-dk)}
.ppc-ph i{font-style:normal;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10.5px}
  ...
  <ol class="ppc-list">
    ...
    <li class="ppc-step">
      ...
      <figure class="ppc-figure">
        <span class="ppc-ph"><b>3D 피부 분석기 사진</b>기기로 피부를 촬영하거나<br>측정 결과 화면을 보는 장면<br><i>4:3 · 1200×900</i></span>
      </figure>
    ...
    <li class="ppc-step">
      ...
      <figure class="ppc-figure">
        <span class="ppc-ph"><b>맞춤 설계 사진</b>의료진이 진단 결과를 놓고<br>장비 조합을 설명하는 장면<br><i>4:3 · 1200×900</i></span>
      </figure>
    ...
    <li class="ppc-step">
      ...
      <figure class="ppc-figure">
        <span class="ppc-ph"><b>시술 장면 사진</b>장비 핸드피스를 얼굴에<br>적용하는 클로즈업<br><i>4:3 · 1200×900</i></span>
      </figure>
    ...
    <li class="ppc-step">
      ...
      <figure class="ppc-figure">
        <span class="ppc-ph"><b>회복 관리 사진</b>시술 후 진정·재생 케어를<br>받는 장면<br><i>4:3 · 1200×900</i></span>
      </figure>
