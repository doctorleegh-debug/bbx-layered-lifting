...
\r
  <header class="plc-head">\r
    ...
    <h2 class="plc-h2" id="plc-title">하나로 끝내지 않습니다.<br><em>아홉 대를 층에 맞춰</em> 조합합니다.</h2>\r
...
.pfz-help{width:calc(100% - 48px);max-width:1440px;margin:13px auto 0;font-size:13px;line-height:1.6;color:#86716e;text-align:right}
.pfz-detail{display:grid;grid-template-columns:140px minmax(0,1fr);gap:24px;align-items:start;
  width:calc(100% - 48px);max-width:1440px;margin:16px auto 0;padding:22px 0;border-top:1px solid var(--line)}
.pfz-detail-title{margin:0;font-size:22px;line-height:1.5;letter-spacing:-.6px;color:var(--c-dk);font-weight:700}
.pfz-detail-text{margin:0;max-width:820px;font-size:16px;line-height:1.85;letter-spacing:-.35px;color:var(--ink2);
...
@media(max-width:820px){
  ...
  .pfz-layout,.pfz-help,.pfz-detail{width:calc(100% - 32px)}
  ...
  .pfz-labels{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));column-gap:12px;row-gap:0;margin-top:12px}
  .pfz-label-wrap{position:static;width:auto;min-width:0;transform:none}
  .pfz-label{justify-content:center;min-height:46px;padding:11px 4px;text-align:center}
  .pfz-label-name{font-size:15px}
  .pfz-label-hint{display:none}
  .pfz-label:focus-visible{outline-offset:0}
  .pfz-help{font-size:12px;margin-top:12px;text-align:center}
  .pfz-detail{grid-template-columns:1fr;gap:6px;margin-top:16px;padding:18px 0 0}
  .pfz-detail-title{font-size:19px}
  .pfz-detail-text{font-size:14px;line-height:1.8}
}
@media(prefers-reduced-motion:reduce){
...
<section class="pfz-sec" aria-labelledby="pfz-title">
  ...
  <div class="pfz-layout">
    <div class="pfz-stage" id="pfz-stage">
      ...
      <button class="pfz-dot is-active" data-z="forehead" data-x="49.5" data-y="28.8" type="button" aria-label="이마 부위 설명" aria-pressed="true" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="eye" data-x="57" data-y="41.5" type="button" aria-label="눈가 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="undereye" data-x="45.8" data-y="44.8" type="button" aria-label="눈밑 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="cheek" data-x="44.5" data-y="50.8" type="button" aria-label="앞볼 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="fold" data-x="52.7" data-y="53.5" type="button" aria-label="팔자 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="mouth" data-x="46.1" data-y="60" type="button" aria-label="입가 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="jaw" data-x="54.4" data-y="58.1" type="button" aria-label="턱선 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="chin" data-x="49.1" data-y="67.8" type="button" aria-label="턱밑 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <button class="pfz-dot" data-z="neck" data-x="48" data-y="74.5" type="button" aria-label="목 부위 설명" aria-pressed="false" aria-controls="pfz-detail"></button>
      <p class="pfz-image-note" hidden>인물 이미지를 불러오지 못했습니다. 아래 부위 이름을 선택해 설명을 확인하세요.</p>
    </div>
    <ul class="pfz-labels" aria-label="얼굴과 목의 세부 부위">
      <li class="pfz-label-wrap" data-side="left" style="--label-y:23%">
        <button class="pfz-label is-active" data-z="forehead" data-description="피부의 탄력 변화와 미세주름을 살펴봅니다." type="button" aria-pressed="true" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="right" style="--label-y:29%">
        <button class="pfz-label" data-z="eye" data-description="피부가 얇아 미세주름이 빨리 생깁니다. 눈꺼풀이 처지면서 피곤한 인상이 됩니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="left" style="--label-y:39%">
        <button class="pfz-label" data-z="undereye" data-description="눈밑이 볼록해지면서 피곤한 인상이 됩니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="left" style="--label-y:54%">
        <button class="pfz-label" data-z="cheek" data-description="피부 두께와 탄력이 떨어지면서 꺼짐이 생깁니다. 혈관이 변하면서 붉은기와 피부톤 불균일이 나타납니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="right" style="--label-y:48%">
        <button class="pfz-label" data-z="fold" data-description="피부 두께와 탄력이 떨어지면서 꺼짐이 생깁니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="left" style="--label-y:69%">
        <button class="pfz-label" data-z="mouth" data-description="지방이 아래로 처지면서 입가에 골이 생깁니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="right" style="--label-y:66%">
        <button class="pfz-label" data-z="jaw" data-description="턱선 지지력이 약해지면서 윤곽이 무너집니다. 경계가 흐려지면 얼굴이 넓어 보입니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="right" style="--label-y:83%">
        <button class="pfz-label" data-z="chin" data-description="턱 아래 지방이 쌓이면서 이중턱이 만들어집니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
      ...
      <li class="pfz-label-wrap" data-side="left" style="--label-y:86%">
        <button class="pfz-label" data-z="neck" data-description="피부가 얇아 탄력이 떨어지고 주름이 쉽게 생깁니다. 주름이 깊어지면 나이 들어 보이고 인상이 흐려집니다." type="button" aria-pressed="false" aria-controls="pfz-detail">
          <span class="pfz-label-name">목</span><span class="pfz-label-hint">탄력 저하 · 깊어진 주름</span>
        </button>
      </li>
    </ul>
  </div>
  <p class="pfz-help">부위 이름이나 표시점을 눌러 확인하세요.</p>
  <div class="pfz-detail" id="pfz-detail" aria-live="polite" aria-atomic="true">
    <h3 class="pfz-detail-title">이마</h3>
    <p class="pfz-detail-text">피부의 탄력 변화와 미세주름을 살펴봅니다.</p>
  </div>
</section>
<script>
...
(function(){
  ...
  function select(key){
    ...
    root.querySelector('.pfz-detail-title').textContent=label.querySelector('.pfz-label-name').textContent;
    root.querySelector('.pfz-detail-text').textContent=label.dataset.description||'';
    playLabel(label,0);
  }
